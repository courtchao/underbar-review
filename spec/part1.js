(function() {
  ...
  describe('Part I', function() {
    ...
    describe('last', function() {
      ...
      it('should accept an index argument', function() {
        expect(_.last([1, 2, 3], 2)).to.eql([2, 3]); //come back to see order
      });
    ...
    describe('each', function() {
      ...
      it('should only iterate over numeric keys of an array, not all properties', function() {
        ...
        expect(iterations).to.not.include(letters.someProperty); //double check this later
      });
    ...
    describe('pluck', function() {
      ...
      it('should not modify the original array', function() {
        ...
        expect(people).to.not.equal([{ name: 'moe', age: 30 }, { name: 'curly', age: 50 }]); //double check this
      });
    });
    ...
    describe('reduce', function() {
      ...
      it('should multiply all items in the collection by the memo, which is zero', function() {
        var result = _.reduce([1, 2, 3], function(memo, item) {
          return memo * item;
        }, 0);
